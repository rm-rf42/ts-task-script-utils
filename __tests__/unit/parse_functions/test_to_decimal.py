...
def test_to_decimal_very_large_float():
    ...
    # Assert
    assert actual.compare_total(Decimal(".0")) == 0
...
def test_to_decimal_very_large_negative_float():
    ...
    # Assert
    assert actual.compare(Decimal("-.0")) == 0
